...
GO.billing.ProductsGrid = function(config){
	...
	var fields ={
		fields:['id','type', 'name','sort_order','category_id','image','cost_price','list_price','vat','total_price','supplier','supplier_product_id','allow_bonus_points','special','special_list_price','special_total_price','charge_shipping_costs','stock','bonus_points','required_products', 'iconCls', 'description', 'stock_min', 'amount', 'article_id', 'unit_stock','article_id'].concat(go.customfields.CustomFields.getFieldDefinitions("Product")),
		columns:[
			{
				header: t("Name"),
				dataIndex: 'name',
...
//	}];
	...
	fields.columns = fields.columns.concat(go.customfields.CustomFields.getColumns("Product"));
