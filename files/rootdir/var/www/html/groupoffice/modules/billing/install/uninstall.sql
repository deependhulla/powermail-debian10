...
DROP TABLE IF EXISTS `bs_item_product_option`, `bs_order_item_groups`, `bs_product_option`, `bs_product_option_language`, `bs_product_option_value`, `bs_product_option_value_language`;