...
//	config.title = t("Tickets", "tickets");
	...
	var fields ={
		fields:['id','ticket_number','priority','priority_name','agent_id','agent_name','due_date', 'contact_name','subject','ctime','mtime','status','status_id','type','unseen','email','phone','company','level','late','type_id','last_response'].concat(go.customfields.CustomFields.getFieldDefinitions("Ticket")),
		columns:[
		{
			header: '&nbsp;',
			id:'icon',
